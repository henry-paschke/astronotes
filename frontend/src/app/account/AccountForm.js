...
function UsernameCard() {
  ...
  async function handleSubmit(e) {
    ...
    setStatus(null);
    if (!newUsername.trim()) {
      setStatus({ type: "error", msg: "Enter a new username." });
      return;
    }
    setLoading(true);
    try {
      ...
      setStatus({
        type: "success",
        msg: `Username changed to "${data.username}".`,
      });
      setNewUsername("");
      setCurrentPassword("");
    } catch (err) {
        ...
        <div className={styles.cardHead}>
          ...
          <div>
            ...
            <p className={styles.cardDesc}>
              Change how you appear across AstroNotes
            </p>
          </div>
        </div>
...
function PasswordCard() {
  ...
  async function handleSubmit(e) {
    ...
    setStatus(null);
    if (!newPassword) {
      setStatus({ type: "error", msg: "Enter a new password." });
      return;
    }
